...
const api: AgentMuxPreloadApi = {
  ...
  browser: {
    ...
    runScript: (id: string, code: string, operator?: BrowserOperator) => ipcRenderer.invoke('browser:runScript', id, code, operator),
    ...
    stopOperation: (id: string) => ipcRenderer.invoke('browser:stopOperation', id),
