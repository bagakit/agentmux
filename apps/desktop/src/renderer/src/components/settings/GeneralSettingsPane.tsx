    ...
    <div className="settings-pane-stack">
      <section className="settings-card settings-card--hero">
        ...
        <div>
          ...
          <p>AgentMux keeps provider discovery, tmux lifecycle, status hooks and terminal transport in the framework-independent Core package.</p>
        </div>
      </section>
      <section className="settings-card">
        <div className="settings-row-heading"><SquareTerminal size={15} /><div><h3>Terminal-first sessions</h3><p>Every coding agent runs inside a durable tmux session and remains available when the desktop app closes.</p></div></div>
      </section>
      <section className="settings-card">
